...
GATEWAY_HOST = "my-cloudrun-gateway-v3-8-8zdyvvn4.uk.gateway.dev"
API_KEY = "AIzaSyC5lZ8PPg2WX-mEMasNiBXnBhsduFsHPcw"

# -----------------------------------------

def get_server_status(BASE_URL:str, API_KEY:str):
    """
    ...
    endpoint = f"https://{BASE_URL}/openapi.json"
...
def run_calculator_tool(BASE_URL:str, API_KEY:str, num1: float, num2: float, operation: str = "add"):
    """
    ...
    """
    endpoint = f"https://{BASE_URL}/api/calculator"
...
# The API Gateway URL, including the path defined in the OpenAPI spec
base_url = f"https://{GATEWAY_HOST}/ready"
...
try:
    ...
    response_unauth = requests.get(base_url) 
...
if __name__ == "__main__":
    ...
    get_server_status(GATEWAY_HOST, API_KEY)
    
    # Run the simple calculator tool
    run_calculator_tool(GATEWAY_HOST, API_KEY, num1=5.5, num2=10.2, operation="add")
